...
# modal deploy --name lateral-vllm-qwen35-4b /iris/u/asap7772/lateral_thinking/lateral_think/inference/modal_launch_vllm.py


# MODAL_VLLM_MODEL_NAME=openai/gpt-oss-20b \
# MODAL_VLLM_APP_NAME=lateral-vllm-gpt-oss-20b \
# MODAL_VLLM_WEB_LABEL=lateral-vllm-gpt-oss-20b \
# MODAL_VLLM_REQUIRES_PROXY_AUTH=0 \
# MODAL_VLLM_MIN_CONTAINERS=1 \
# modal deploy --name lateral-vllm-gpt-oss-20b /iris/u/asap7772/lateral_thinking/lateral_think/inference/modal_launch_vllm.py
...
"""Launch a configurable multi-GPU vLLM session with Modal."""
...
APP_NAME = os.environ.get("MODAL_VLLM_APP_NAME", "example-vllm-inference-run")
MODEL_NAME = os.environ.get("MODAL_VLLM_MODEL_NAME", "Qwen/Qwen3.5-4B")
...
WEB_ENDPOINT_LABEL = os.environ.get(
    ...
    APP_NAME if "MODAL_VLLM_APP_NAME" in os.environ else "lateral-vllm",
)
WEB_MIN_CONTAINERS = _get_env_int("MODAL_VLLM_MIN_CONTAINERS", 0)
...
WEB_REQUIRES_PROXY_AUTH = _get_env_bool("MODAL_VLLM_REQUIRES_PROXY_AUTH", True)
...
MAX_MODEL_LEN = _get_env_int("MODAL_VLLM_MAX_MODEL_LEN", 32768)
